          ...
          <Col lg={6} md={8}>
            <div className="title text-center mb-5">
              <h3 className="font-weight-normal text-dark">
                <span className="text-warning">Project Vision</span>
              </h3>
              <p className="text-muted">
                The vision of TurboTurtle is to create a fun, engaging, and
                futuristic meme token that captures the imagination of the
                cryptocurrency community. TurboTurtle aims to build upon the
                success of existing meme tokens while introducing minor
                improvements to drive further growth and market adoption.
              </p>
            </div>
          </Col>
        </Row>
